...
The goal of this repository is to create a structured, reusable system for analytical writing and study.

It serves as a home for:
- essay source materials
- draft structures
- references and reading notes
- simulations and small experiments
- code used to generate figures or examples
- reusable templates for future documents

This repository helps me preserve not only final outputs, but also the reasoning assets used to create them.
...
This is not:
- a random dump of raw notes
- a collection of unfinished files without context
...
A typical essay or analytical piece may include:
- a short README explaining the topic and goal
- a draft document
- references or source notes
- figures or charts
- notebooks or scripts used for examples, calculations, or simulations
- reusable helper code where appropriate

Example structure:

```text
essays/
  expected-value-vs-most-likely/
    README.md
    draft.md
    references.md
    figures/
